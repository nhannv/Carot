...
using Carot.ERP.Crm.Models;
using Carot.ERP.Database;
using Carot.ERP.Plugins;

namespace Carot.ERP.Crm
{
	[PluginStartup]
	public partial class Startup
	{
		...
		//Code snippets
		//Check out the CodeSnippets.txt file in Carot.ERP.Web > Docs folder for code pieces on how to create or update some elements		
