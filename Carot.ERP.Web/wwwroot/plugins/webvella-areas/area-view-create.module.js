...
(function () {
	...
	angular
        ...
        .controller('CarotAreasRecordCreateController', controller);
	...
	function config($stateProvider) {
		$stateProvider.state('webvella-area-view-create', {
			...
			views: {
				"topnavView": {
					controller: 'CarotAreasTopnavController',
					templateUrl: '/plugins/webvella-areas/topnav.view.html',
					controllerAs: 'topnavData'
				},
				"sidebarView": {
					controller: 'CarotAreasSidebarController',
					templateUrl: '/plugins/webvella-areas/sidebar.view.html',
					controllerAs: 'sidebarData'
				},
				"contentView": {
					controller: 'CarotAreasRecordCreateController',
			...
			views: {
				...
				"sidebarView": {
					controller: 'CarotAreasDetachedItemSidebarController',
